...
import estilo from "./Pagemobile.module.css"

export default function Mobile() {
  return (
    <>
      <div className={estilo.container_mobile}>
        <h2>React Native</h2>
        <p>
        ...
        <Link href="https://www.devmedia.com.br/carreira-programador/?slug=mobile" target="_blank">Guia de Mobile</Link>
